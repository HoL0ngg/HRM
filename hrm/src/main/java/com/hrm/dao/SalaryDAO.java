...
// Tạo đối tượng SalaryChangeHistory
    ...
    public boolean updateSalary(int employeeID, BigDecimal bonus, BigDecimal attendance, BigDecimal deductions,
            String note, LocalDate payday, BigDecimal net_salary) {
        // Câu lệnh SQL để cập nhật thông tin lương
    ...
    public ArrayList<Salary> selectByEmployeeIdforDanhSachLuong(int employeeId) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                // Tạo đối tượng Salary và thêm vào danh sách
                Salary salary = new Salary(id, employee, positionSalary, bonus, deductions, net_salary, overtimeSalary,
                        payday, note, attendance, position, tax, social_insurance);
                salaryList.add(salary);
            }
