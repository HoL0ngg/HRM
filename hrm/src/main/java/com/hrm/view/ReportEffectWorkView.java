...
public class ReportEffectWorkView extends JFrame {
    ...
    public ReportEffectWorkView() {
     ...
     // Panel bên phải cho avatar và tên
        ...
        JLabel ghiChuLabel = new JLabel("Báo cáo hiệu suất làm việc của nhân viên");
  ...
  // Nút xuất Excel với biểu tượng
     ...
     tableModel = new DefaultTableModel(
             new String[]{"STT", "Tên nhân viên", "Phòng ban", "Tỷ lệ hoàn thành công việc"}, // Sửa tên cột
             0
     );
     ...
     loadTableData(reportController.getEmployeeWorkEffect());
    }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new ReportEffectWorkView().setVisible(true));
    }
}
