...
>>>>>>> c7d6a271d5dcec4338ff0ba725bbc59b91b9538c
    ...
    private void btnRefreshDataYeuCauThayDoiActionPerformed(java.awt.event.ActionEv ent evt) {//GEN-FIRST:event_btnRefreshDataYeuCauThayDoiActionPerformed
        loadDataToYeuCauTangLuongTable();
    }// GEN-LAST:event_btnRefreshDataYeuCauThayDoiActionPerformed

    private void tblYeuCauTangLuongMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:eve nt_tblYeuCauTangLuongMouseClicked
    ...
    private void tblDanhSachLuongMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:eve nt_tblDanhSachLuongMouseClicked
 ...
 * private void cbbThangActionPerformed(ActionEvent evt) {
     ...
     * tableData[i][0] = salary.getEmployee().getId();
     * 
     * tableData[i][2] = salary.getPosition().getNa
     * tableData[i][3] = salary.getPositionSalary
     * tableData[i][4] = salary.getOvertimeSalary();
     * tableData[i][5] = salary.getAttendance();
     * tableData[i][6] = salary.getBonus();
     ...
     * }
     * 
     * DefaultTableModel model = new DefaultTabl
     * String[]{"Mã nhân viên", "Họ và tên", "V
     * "
     * 
     * }
     * 
     * private void tblDanhSachLuongMouseClicked(MouseEvent evt) {
     * int selectedRow = this.tblDanhSachLuon
     * i
     * 
     * 1).toString();
     * String position = this.tblDanhSachLuong.getValueAt(select
     * 2).toString();
     * String totalSalary = this.tblDanhSachLuong.getValueAt(selectedRow,
     * 8).toString();
     * String overtimeSalary = this.tblDanhSachLuong.getValueAt(select
     * 4).toString();
     * String bonus = this.tblDanhSachLuong.getValueAt(selectedRow, 6).to
     * String deducti
     * 7).toString();
     * String note = 
     ...
     * }
     * 
     * final JTable departmentTab
     * departmentTable.setSelection
     * J
     * 
     ...
     * JButton btnChonPhong = new JButton
     * dialog.add(btnChonPhong, 
     * btnChonPhong.addActionListener(new ActionListe
     * public void actionPerformed(Actio
     * int selectedRow = departmentTable.getSelectedRow(
     * if (selectedRow >= 0) {
     * int departmentId = (Integer)departmentTable.getValueA
     * String departmentName = (String)departmentTabl
     * JOptionPane.showMessageDialog((Component)null, "Bạn
     * departmentName + " (ID:
     * dialog.dispose();
     * } else {
     ...
     * 
     * pri
     * int selectedRow = this.t
     * i
     * 
     * 0);
     * SalaryChangeHistoryDAO salaryChangeHistoryDAO =
     * SalaryChangeHistoryDAO.g
     * SalaryChangeHistory salaryChangeHistory =
     * sal
     * SalaryUpdateDialog dialog = new SalaryUpdateDia
     * salaryChangeHistory);
     * dialog.setVisible(true);
     * }
     * 
     ...
     * this.loadDataToYeuCauTangLuongDaXemTab
     * }
     * 
     * public static void main(String[] args) {
     * try {
     ...
     * (
     * }
     * Logger.getLogger(SalaryFrame1.class.get
     * (String)null, var6);
     * } catch (IllegalAcce
     * Logger.getLogger(SalaryFrame1.class.get
     * (String)null, var7);
     * } catch (Unsupported
     * UnsupportedLookAndFeelException ex = va
     ...
     * 
     * private void loadDataToYeuCauTangLuongTable() {
     * this.tblYeuCauTangLuong.setRowHeight(3
     * S
     * 
     * ArrayList<SalaryChangeHistory> salaryChangeList
     * salaryChangeHistoryDAO.selectAllWithEmplo
     * Object[][] tableData = new Object[salaryChangeL
     * 
     * for(int i = 0; i < salaryChangeList.size(); ++i) 
     * SalaryChangeHistory history = (SalaryChangeHist
     * tableData[i][0] = history.getId();
     * 
     * tableData[i][2] = history.getOldSalary();
     * tableData[i][3] = history.getNewSalary();
     * tableData[i][4] = history.getChang
     * tableData[i][5] = history.getReasons();
     * tableData[i][6] = history.getStatus();
     * }
     * 
     * DefaultTableModel model = new DefaultTa
     * "Nhân viên", "Lương cũ", "Lương mới", 
     * "
     * 
     ...
     * 
     * for(int i = 0; i < salaryChangeList.size(); ++i) 
     * SalaryChangeHistory history = (SalaryCha
     * Object[] var10000 = tableData[i];
     * 
     * var10000[0] = "NV" + String.format("%03d", var1000
     * tableData[i][1] = history.getEmployee().getName();
     * tableData[i][2] = history.getOldS
     * tableData[i][3] = history.getNewSalary();
     * tableData[i][4] = history.getReasons();
     * tableData[i][5] = history.getChangeDate();
     * tableData[i][6] = history.getApprovedBy()
     * tableData[i][7] = history.getComments();
     * }
     * 
     * DefaultTableModel model = new DefaultTableModel(tabl
     * String[]{"Mã nhân viên", "Họ và tên", "L
     * "
     * 
     * }
     * }
    ...
    private void cbPhongBanActionPerformed(ActionEvent evt) {
        ...
        for(int i = 0; i < departmentList.size(); ++i) {
            Department dept = (Department)d e partmentList.get(i); 
            data[i][0] = dept.getId();
        ...
        btnChonPhong.addActionListener(new Actio nListener() {
            public void actionPerformed(ActionEvent evt) {
                ...
                if (selectedRow >= 0) {
                    ...
                    JOptionPane.showMessageDialog((C omponent)null, "Vui lòng chọn một phòng ban");
                } 
